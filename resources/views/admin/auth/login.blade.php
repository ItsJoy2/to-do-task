...
<head>
    ...
    @if($generalSettings && $generalSettings->favicon)
        <link rel="icon" type="image/png" href="{{ asset(str_replace('public/', '', $generalSettings->favicon)) }}">
        <link rel="apple-touch-icon" href="{{ asset(str_replace('public/', '', $generalSettings->favicon)) }}">
    @else
