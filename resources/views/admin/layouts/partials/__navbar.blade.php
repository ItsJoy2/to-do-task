						...
						<ul class="navbar-nav topbar-nav ms-md-autnavbar navbar-header  navbar-expand-lg border-bottom o align-items-center">
							...
							<li class="nav-item topbar-user dropdown hidden-caret">
								<a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false">
									<div class="avatar-sm">
										<img src="{{ asset('storage/' . $generalSettings->favicon) }}" alt="..." class="avatar-img rounded-circle">
									</div>
...
{{--												<div class="avatar-lg"><img src="{{ Storage::url($generalSettings->favicon) }}" alt="image profile" class="avatar-img rounded"></div>--}}
												<div class="u-text">
													...
													<p class="text-muted">{{ auth()->user()->email }}</p><a href="{{route('admin.profile.edit')}}" class="btn btn-xs btn-secondary btn-sm">View Profile</a>
												</div>
											</div>
										</li>
										<li>
