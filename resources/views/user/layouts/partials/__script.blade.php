<!-- plugins:js -->
  <script src="{{ asset('assets/user/vendors/js/vendor.bundle.base.js') }}"></script>
    ...
    <script src="{{ asset('assets/user/vendors/progressbar.js/progressbar.min.js') }}"></script>
    <script src="{{ asset('assets/user/vendors/jvectormap/jquery-jvectormap.min.js') }}"></script>
    <script src="{{ asset('assets/user/vendors/jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
    <script src="{{ asset('assets/user/vendors/owl-carousel-2/owl.carousel.min.js') }}"></script>
